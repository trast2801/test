...
print('Мастера кода решили задачи за {0:5.1f} с !'.format(team1_time))
print('Волшебники данных решили задачи за {0:5.1f} с !'.format(team2_time))

print(f'Команды решили {score1} и {score2} задач.\n')
print(f'Сегодня было решено {tasks_total} задач, в среднем по {time_avg:5.1f} секунды на задачу!.')
